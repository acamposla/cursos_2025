...
Estoy trabajando para completar la certificación profesional de IBM Data Analyst, que consta de 11 cursos diseñados para desarrollar habilidades esenciales en Python, SQL, Excel y herramientas analíticas avanzadas. Mi progreso se detalla a continuación:

| Curso                                                 | Estado        | Diploma                                                        |
|-------------------------------------------------------|---------------|----------------------------------------------------------------|
| [Introduction to Data Analytics](Intro_to_Data_Analytics/) | ✅ Completado | [Ver diploma](https://coursera.org/verify/N9FOVQSE0IHD)         |
| Excel Basics for Data Analysis                        | 🕒 En curso | N/A                                                            |
| Data Visualization and Dashboards with Excel and Cognos | 🕔 Planeado | N/A                                                            |
| Python for Data Science, AI & Development             | 🕔 Planeado | N/A                                                            |
| Python Project for Data Science                       | 🕔 Planeado | N/A                                                            |
| Databases and SQL for Data Science with Python        | 🕔 Planeado | N/A                                                            |
| Data Analysis with Python                             | 🕔 Planeado | N/A                                                            |
| Data Visualization with Python                        | 🕔 Planeado | N/A                                                            |
| IBM Data Analyst Capstone Project                    | 🕔 Planeado | N/A                                                            |
| Generative AI: Enhance your Data Analytics Career     | 🕔 Planeado | N/A                                                            |
| Data Analyst Career Guide and Interview Preparation   | 🕔 Planeado | N/A                                                            |
...
### Álgebra 1 (Khan Academy)
Para fortalecer mis bases teóricas en álgebra, estoy completando el curso "Álgebra 1" en Khan Academy, el cual consta de 16 unidades. Mi progreso actual:

| Unidad                                               | Estado        | Notas                   |
|------------------------------------------------------|---------------|-------------------------|
| Fundamentos de álgebra                               | ✅ Completado | Base sólida de conceptos|
| Resolver ecuaciones y desigualdades                 | 🕔 Planeado  | -                       |
| Trabajar con unidades                                | 🕔 Planeado  | -                       |
| Ecuaciones lineales y gráficas                       | 🕔 Planeado  | -                       |
| Formas de ecuaciones lineales                        | 🕔 Planeado  | -                       |
| Sistemas de ecuaciones                               | 🕔 Planeado  | -                       |
| Desigualdades (sistemas y gráficas)                  | 🕔 Planeado  | -                       |
| Funciones                                            | 🕔 Planeado  | -                       |
| Sucesiones                                           | 🕔 Planeado  | -                       |
| Valor absoluto y funciones definidas por partes      | 🕔 Planeado  | -                       |
| Exponentes y radicales                               | 🕔 Planeado  | -                       |
| Crecimiento y decaimiento exponencial                | 🕔 Planeado  | -                       |
| Cuadráticas: multiplicación y factorización          | 🕔 Planeado  | -                       |
| Funciones y ecuaciones cuadráticas                   | 🕔 Planeado  | -                       |
| Números irracionales                                 | 🕔 Planeado  | -                       |
| Creatividad en el álgebra                            | 🕔 Planeado  | -                       |

### Estadística de Secundaria (Khan Academy)
Estoy desarrollando mis habilidades en estadística y probabilidad a través del curso "Estadística de secundaria" en Khan Academy, que consta de 7 unidades. Mi progreso actual:

| Unidad                                               | Estado        | Notas                   |
|------------------------------------------------------|---------------|-------------------------|
| Gráficas de dispersión                               | ✅ Completado | Exploración gráfica de datos|
| Distribuciones de datos                             | 🕒 En curso | Análisis de distribuciones|
| Tablas de contingencia                               | 🕔 Planeado  | -                       |
| Diseño de estudios                                   | 🕔 Planeado  | -                       |
| Probabilidad                                         | 🕔 Planeado  | -                       |
| Probabilidad binomial                                | 🕔 Planeado  | -                       |
| Distribuciones normales                             | 🕔 Planeado  | -                       |
...
## 🚀 Desarrollo diario
Trato de realizar una kata diaria en Codewars para practicar Python y mejorar mis habilidades de resolución de problemas. Los resultados y aprendizajes se reflejan en ejercicios adicionales.

## 📁 Organización del repositorio
El repositorio incluye carpetas para cada curso, organizadas con:
- Apuntes en formato Markdown.
- Jupyter Notebooks con ejercicios prácticos.
- Scripts en Python y SQL desarrollados a lo largo de los cursos.
